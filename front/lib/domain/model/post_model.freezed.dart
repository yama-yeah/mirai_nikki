...
class _$_PostModel with DiagnosticableTreeMixin implements _PostModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PostModel(id: $id, title: $title, description: $description, image: $image, deadline: $deadline)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, image, deadline);
...
abstract class _PostModel implements PostModel {
  const factory _PostModel(
      ...
      final String description,
      final String image,
      final int deadline}) = _$_PostModel;
